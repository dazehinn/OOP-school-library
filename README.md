...
```
 git@github.com:dazehinn/OOP-school-library.git
```
...
- Twitter: [nketchogue](https://twitter.com/hilaryndzi)
...
Feel free to check the [issues page](https://github.com/dazehinn/oop-school-library/issues).
...
This project is [MIT](https://github.com/dazehinn/oop-school-library/blob/Dev/LICENSE) licensed.
